...
def test_ship_gate_status_from_yield_keeps_not_measured_separate_from_below_gate() -> None:
    assert module.ship_gate_status_from_yield(None) == "not_measured"
    assert module.ship_gate_status_from_yield(59.9) == "below_gate"
    assert module.ship_gate_status_from_yield(60.0) == "pass"
