# EIDP v545 Owner Return Fill Sheet

Date: 2026-06-21
Scope: v545 owner/operator return evidence only
...
3. the operator runs one real Stage 6 cycle on the v545 side-by-side lane; and
...
| E2E field | Value |
| --- | --- |
| EIDP package commit | `f3eb1663c0333f296856a84f447ef2424ea77ddf` |
| core ZIP ファイル名 | `eidp-windows-v545.zip` |
| core ZIP sha256 | `ba4d36189d671ce59e01cf8f1bffeb0710d8d2b171376e4cbc0cb4e362f1b8d0` |
| transferred ZIP | `C:\EIDP-staging\eidp-windows-v545.zip` |
...
| GitHub main CI | packaged source commit f3eb166: CI `27888117592` -> success; latest v545 false-reject docs commit cf588e2: CI `27889303389` -> success; re-check current `main` before release approval |
...
| after-weekly validation evidence | `docs/reports/2026-06-21-v545-disclosure-priority-windows-canary.md` records after-weekly validator `ok=true` |
| bounded canary evidence | strict/Excel-ready `12/50 (24.0%)`, operator-reviewable `47/50 (94.0%)`, `ship_gate_status=below_gate` |
| Stage 6 evidence verify | `logs/win-v545-f3eb166-canary/stage6-evidence-verify-20260621-094157.json` -> `ok=true` |
...
The v545 bounded canary is side-by-side smoke evidence only. It is not owner
real-cycle sign-off evidence.

## Short Owner Decision Form

Use `docs/runbooks/eidp-v545-release-summary.md` as the owner-facing one-page
summary and `docs/runbooks/eidp-v545-owner-signoff.md` as the short owner
decision form. Do not ask the owner to manually fill or reproduce the
engineering checklist.

For v545, current evidence supports `NOT_READY` only. `publication_lag`
...
- v545 setup validation evidence
- v545 active-task recovery JSON
...
Developer validation is run from current `main`, or from the staged v545
...
uv run python scripts/verify_stage6_return.py \
  ...
  --owner-signoff docs/runbooks/eidp-v545-owner-signoff.md \
  --expected-package-sha256 ba4d36189d671ce59e01cf8f1bffeb0710d8d2b171376e4cbc0cb4e362f1b8d0 \
  --expected-source-commit f3eb1663c0333f296856a84f447ef2424ea77ddf \
  --false-reject-evidence-zip logs/win-v545-f3eb166-canary/stage6-evidence-20260621-004156.zip \
  --false-reject-review-csv docs/reports/2026-06-21-v545-false-reject-review-sheet.csv \
