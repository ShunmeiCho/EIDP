# EIDP v495 Side-by-Side Validation Runbook

Updated: 2026-05-19

## Superseded

Superseded by v497. Do not transfer or validate v495 unless a release engineer
...
This runbook validates v495 on the Windows operator PC without promoting the
...
| Item | Value |
| --- | --- |
| Package | `dist/eidp-windows-v495.zip` |
| SHA256 | `e55c1b2de2b74181f9d29120ba9b074c5d14c82bf4d74ef41c07ff8e84e623c8` |
| Package/source commit | `37b5118d3bf9a9a50b281ec0d87bedcf2242d475` |
| Target Windows root | `%USERPROFILE%\EIDP-v495-37b5118` |
...
```powershell
$zip = "C:\EIDP-staging\eidp-windows-v495.zip"
$expected = "e55c1b2de2b74181f9d29120ba9b074c5d14c82bf4d74ef41c07ff8e84e623c8"
$root = Join-Path $env:USERPROFILE "EIDP-v495-37b5118"
...
.\scripts\validate_install.bat --after-setup --json |
  Tee-Object -FilePath "logs\win-v495-stage6-v495-validate-after-setup-20260519.json"

.\scripts\stage6_recovery_check.bat $activeAction --json |
  Tee-Object -FilePath "logs\win-v495-stage6-v495-recovery-expected-v485-20260519.json"
```
...
to v495 unless release scope is explicitly decided and owner E2E is scheduled.
