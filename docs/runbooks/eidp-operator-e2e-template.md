...
- v412 は最新の Mac / non-Windows release-gate-clean ZIP です。ただし
  SSH-Win 断線中のため Windows transfer / setup / UI 証跡は未取得です。次の
  real-cycle Stage 6 は、明示的に v408 lane 継続を選ぶ場合を除き、v412 を
  転送して下表の実施情報を v412 値で埋めます。
...
v412 投入候補（Mac / non-Windows gate 済み、Windows 未実証）:

| 項目 | 値 |
| --- | --- |
| EIDP package snapshot | `dbafdc34be4f8d753e6f5bcfb6bec35495fefce0` |
| core ZIP | `dist/eidp-windows-v412.zip` |
| core ZIP sha256 | `342996181d45eccdb4f9b141747572239579b6f03554d01b7f7721dc456186b1` |
| non-Windows gate log | `logs/release-gate-v412-retroactive.json` |
