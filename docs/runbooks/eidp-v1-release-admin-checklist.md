...
current v548 r2 owner-docs ZIP. Windows retained active v527, fallback v547, and
...
`dist/eidp-v548-owner-docs-20260622-r2.zip`, staged at
`C:\EIDP-staging\v548-owner-docs-20260622-r2`; its exact SHA256 is recorded in the
external staging report and `.sha256` sidecar rather than inside the ZIP.
Previous 2026-06-21 v548 and v547 owner-docs staging are historical fallback
handoff evidence.
...
- v548 owner/operator handoff docs staging evidence:
  `docs/reports/2026-06-22-v548-owner-docs-r2-windows-staging.md`,
  `dist/eidp-v548-owner-docs-20260622-r2.zip`, and
  `dist/eidp-v548-owner-docs-20260622-r2.zip.sha256`. The staging report and
  sidecar record the exact v548 owner-docs ZIP SHA256 outside the ZIP; Windows
  extracted destination: `C:\EIDP-staging\v548-owner-docs-20260622-r2`. This is
  documentation/helper handoff only and does not approve v1.0;
