...
Latest audited Windows package commit: `13e57a403e7d5a26c6d4cc064e7220c10879660b` (`eidp-windows-v69.zip`)
...
- `uv run pytest -q` → `806 passed, 5 warnings`
...
- `uv run pytest tests/unit/test_pdf_discovery.py -q` → `20 passed, 5 warnings`
...
- Windows remote ZIP smoke → SHA256 `497f0a83685671125fe5ff132b7b5992ebe815352673ed08c01b89f69bd3b24b`, `settings_page.py` present, `launch.bat` present, `cached_rejections` code present, `BadRcMinusOne=absent`, `BuildCommit=13e57a403e7d5a26c6d4cc064e7220c10879660b`
