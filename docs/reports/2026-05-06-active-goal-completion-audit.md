...
Latest audited Windows package commit: `e3ab234493f3c85ef5e12f7e9278246227fb1132` (`eidp-windows-v84.zip`)
...
| Windows operator delivery | `dist/eidp-windows-v84.zip` rebuilt at commit `e3ab234`, verifier `ok=true`, `git_dirty=false`, SHA256 `480ea922eeb9ccec54956b78552847746099e1fff6c6f3a7220584b573d491e5`, wheelhouse 82 wheels. Latest package includes the current operator runbook, settings page, UI-first weekly rediscovery guidance, browser-proven non-transparent action buttons, bootstrap progress rejection breakdowns, PDF確認 action-lane filtering, 20-second auto-refresh while initial bootstrap is running, and automatic recovery of stale Windows setup locks older than two hours. Latest Mac smoke confirms Streamlit starts, settings page imports, Settings navigation has zero exceptions, and Chrome headless rendering shows `初回URL/PDF取得を開始` as a real styled button. Remote Windows smoke is still only proven through v73: SHA256 match, clean setup exit code 0, `school_count=2418`, `school_fiscal_year_status_count=2418`, official-index yield, and bounded Step 3 cache/prefilter behavior. | Latest package is locally verified and ready for Windows transfer. Full Windows PDF crawl/ingest and UI click-through are still not complete on v84. |
...
- `uv run python scripts/verify_windows_distribution.py dist/eidp-windows-v84.zip` → `OK core`, `git_commit=e3ab234493f3c85ef5e12f7e9278246227fb1132`, `git_dirty=false`, `sha256=480ea922eeb9ccec54956b78552847746099e1fff6c6f3a7220584b573d491e5`, `entry_count=2992`, `wheel_count=82`, `prefecture_seed_rows=47`, `prefecture_seed_parser_supported=47`, `prefecture_seed_downloadable=47`
- `uv run python scripts/verify_windows_distribution.py dist/eidp-windows.zip` → `OK core`, `git_commit=e3ab234493f3c85ef5e12f7e9278246227fb1132`, `git_dirty=false`, `sha256=480ea922eeb9ccec54956b78552847746099e1fff6c6f3a7220584b573d491e5`, `entry_count=2992`, `wheel_count=82`, `prefecture_seed_rows=47`, `prefecture_seed_parser_supported=47`, `prefecture_seed_downloadable=47`
...
2. Run latest v84 ZIP on Windows and verify:
