...
Latest audited Windows package commit: `754e27de44880908dd7a98198fbe2be53190889c` (`eidp-windows-v217.zip`)
...
- 2026-05-11 v217 local package refresh →
  commit `754e27de44880908dd7a98198fbe2be53190889c` hardens the Windows
  install validator's actual SQLite setup gate: `--after-setup` now requires
  the objective-critical `support_recipient` table and records/fails on actual
  `PRAGMA integrity_check` output. The distribution verifier gates the packaged
  validator contract through `support_recipient`, `sqlite_integrity_check`, and
  `PRAGMA integrity_check` tokens. This builds on the v216 CLI deployment-report
  ...
  tests/unit/test_windows_distribution_verifier.py -q` → `93 passed`;
  `uv run pytest tests/unit -q` → `1147 passed, 5 warnings`; `uv run ruff
...
- v217 Windows ZIP artifacts were rebuilt locally at commit
  `754e27de44880908dd7a98198fbe2be53190889c`: `dist/eidp-windows-v217.zip`
  and latest alias `dist/eidp-windows.zip` both have SHA256
  `91c47e37e3454bf591521a456e2b5f976fbdf4daa62037c4e57c46ccb625ea23`.
  `uv run python scripts/verify_windows_distribution.py
  dist/eidp-windows-v217.zip --json` returned `ok=true`, `errors=[]`, and
  ...
  check at `/tmp/eidp-v217-extract` returned `ok=true`, `errors=[]`,
