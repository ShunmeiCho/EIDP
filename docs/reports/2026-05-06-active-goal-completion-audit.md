...
Latest audited Windows package commit: `aa8a1808fddbd6565f3e0b424b04fa353dc17b69` (`eidp-windows-v68.zip`)
...
- `uv run pytest -q` → `805 passed, 5 warnings`
...
- Windows remote ZIP smoke → SHA256 `61110c4d2aeb7479624406b62259f8c27cecfdb4f9fab7cb36193295b67036c6`, `settings_page.py` present, `school_year_tasks.py` present, `bootstrap_pdf_pipeline.py` present, `BadRcMinusOne=absent`, `RcCapture=ok`, `BuildCommit=aa8a1808fddbd6565f3e0b424b04fa353dc17b69`
