...
Latest audited Windows package commit: `37e7e81fb6a3038bc4d80e619fab66daf6a50109` (`eidp-windows-v88.zip`)
...
- `uv run pytest -q` → `830 passed, 5 warnings`
...
- `uv run python scripts/verify_windows_distribution.py dist/eidp-windows-v88.zip` → `OK core`, `git_commit=37e7e81fb6a3038bc4d80e619fab66daf6a50109`, `git_dirty=false`, `sha256=0415da3d4f907b79db2a1c84f00ed5fb243c54bdd6963ca11b2f187c6bddd843`, `entry_count=2994`, `wheel_count=82`, `prefecture_seed_rows=47`, `prefecture_seed_parser_supported=47`, `prefecture_seed_downloadable=47`
- `uv run python scripts/verify_windows_distribution.py dist/eidp-windows.zip` → `OK core`, `git_commit=37e7e81fb6a3038bc4d80e619fab66daf6a50109`, `git_dirty=false`, `sha256=0415da3d4f907b79db2a1c84f00ed5fb243c54bdd6963ca11b2f187c6bddd843`, `entry_count=2994`, `wheel_count=82`, `prefecture_seed_rows=47`, `prefecture_seed_parser_supported=47`, `prefecture_seed_downloadable=47`
...
- Mac bounded online bootstrap smoke on temp SQLite DB, scope `--pref tokyo,kanagawa,saitama --skip-known-url-discovery --url-search off --batch-size 3 --skip-ingest` → `status=succeeded`, artifacts downloaded `3/3`, official index rows `extracted=377`, `matched=354`, `official_school_sites_added=353`, crawl `crawled=3`, `found=3`, `downloaded=0`, `failed=0`, `skipped=21`, `prefiltered=15`, `cached_rejections=2`, documents `0`, prefecture remark review items `2`
- Same bounded online smoke rejection evidence → `fiscal_year_mismatch:2025=3`, `fiscal_year_mismatch:2024=2`, `target_fiscal_year_not_detected=3`, `pre_filtered_non_target_hint=1`; this proves old-year candidates are rejected, not counted as target-year success, on the sampled live sites.
...
2. Run latest v88 ZIP on Windows and verify:
