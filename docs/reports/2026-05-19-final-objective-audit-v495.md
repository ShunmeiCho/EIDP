...
| Package/source freshness | v495 package was built from `37b5118d3bf9a9a50b281ec0d87bedcf2242d475`. `logs/win-v495-stage6-v495-non-windows-release-gates-20260519.json`: `package_source_check.ok=true`, `source_dirty=false`, `stale=false` | PASS |
