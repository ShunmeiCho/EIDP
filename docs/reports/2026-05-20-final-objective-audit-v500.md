...
| Current FY2026 strict yield `>= 60%` | `logs/win-v485-stage6/fy2026-strict-yield-upper-bound-fail-20260519.json`: after 607/1000 denominator schools, FY2026 documents were `0`; maximum possible strict yield was `39.3%`; v500 bounded canary yielded `50.0%` on 10 schools | FAIL |
