...
| Fresh FY2026 limit-50 re-probe | `logs/win-v500-stage6-v500-last-run-after-weekly-canary-limit50-20260520.json`: `status=success`, denominator `50`, strict/Excel-ready yield `4.0%`, operator-reviewable yield `56.0%`, `ship_gate_status=below_gate`; `logs/win-v500-stage6-v500-recovery-probe-lock-after-limit50-canary-20260520.json`: `ok=true`, lock not held, active task still v485 | FAIL for release gate, PASS for recovery |
