...
Date: 2026-05-19
Status: `NOT_APPROVED`
Package candidate: `dist/eidp-windows-v505.zip`
...
| v505 package/non-Windows release gates | `logs/win-v505-stage6-v505-non-windows-release-gates-20260520.json` | `ok=true` |
