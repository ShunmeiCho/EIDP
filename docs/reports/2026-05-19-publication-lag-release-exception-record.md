...
Date: 2026-05-19
Status: `NOT_APPROVED`
Package candidate: `dist/eidp-windows-v506.zip`
...
| v506 package/non-Windows release gates | `logs/win-v506-stage6-v506-non-windows-release-gates-20260520.json` | `ok=true` |
