...
Date: 2026-05-19
Status: `NOT_APPROVED`
Package candidate: `dist/eidp-windows-v517.zip`
...
| v517 package/non-Windows release gates | `logs/win-v517-stage6-v517-non-windows-release-gates-20260520.json` | `ok=true` |
| v517 post-docs-only release gates | `logs/win-v517-stage6-v517-post-docs-only-gates-20260520.json` | `ok=true`, `docs_only_stale=true` |
