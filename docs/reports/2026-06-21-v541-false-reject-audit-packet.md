...
| Audit row ID | School ID | Reason | PDF type | Year evidence | Anchor | Page URL | PDF URL |
| --- | ---: | --- | --- | --- | --- | --- | --- |
| `dbfff69fde58705c` | 4 | `discovery_error` | `` |  |  | `https://www.mode.ac.jp/tokyo` | `https://www.mode.ac.jp/tokyo` |
| `ea968fd128cbd6d8` | 5 | `discovery_error` | `` |  |  | `https://www.mode.ac.jp/osaka` | `https://www.mode.ac.jp/osaka` |
| `b30c01989149762a` | 6 | `discovery_error` | `` |  |  | `https://www.mode.ac.jp/nagoya` | `https://www.mode.ac.jp/nagoya` |
| `6beab549fa1abc5e` | 7 | `discovery_error` | `` |  |  | `https://www.hal.ac.jp/tokyo` | `https://www.hal.ac.jp/tokyo` |
