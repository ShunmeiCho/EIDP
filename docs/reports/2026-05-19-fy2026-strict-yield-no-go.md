...
| Verifier-accepted mature-year proof JSON | `logs/mature-year-acquisition-proof-fy2025-release-exception-v497-20260519.json` |
...
algorithm result, but it is a `strict_yield_gap_analysis` artifact. v497 keeps
...
uv run python scripts/build_mature_year_acquisition_proof.py \
  ...
  --output logs/mature-year-acquisition-proof-fy2025-release-exception-v497-20260519.json \
  --json
```
