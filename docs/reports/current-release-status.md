...
Current source evidence base: `447ba213509898945fb288fe5b30ac0fc1317bcd`
...
Latest historical full non-Windows release-gate package: `dist/eidp-windows-v401.zip` (stale under current verifier)
Latest historical Windows-core-validated package: `dist/eidp-windows-v401.zip` (stale under current verifier)
...
`447ba213509898945fb288fe5b30ac0fc1317bcd`. The latest historical clean ZIP is
...
records a different source commit. Current source also includes the RCA triage
fix that prioritizes explicit `target_fiscal_year_not_detected` target-form
evidence over older-year target evidence for the same school; no ZIP has been
built or Windows-tested from that source evidence base. The older v399 ZIP is
...
resumes and a package lane is explicitly chosen.
...
Mac-verifier-clean candidate. The latest Windows UI-service health proof is now v399; the latest
...
`447ba213509898945fb288fe5b30ac0fc1317bcd`:
...
- `uv run python scripts/run_non_windows_release_gates.py dist/eidp-windows-v401.zip --skip-full-unit --json --output _temp/v401-non-windows-release-gates-stale-commit-ae835a1c.json`
  ...
  `447ba213509898945fb288fe5b30ac0fc1317bcd`, because v401 packages
