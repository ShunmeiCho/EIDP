...
Current Mac-verifier-clean package: `dist/eidp-windows-v388.zip`
Package commit: `8b64f51d919aa14523a4808bd7b038f82b65ea17`
Package SHA256: `399f484299716d481330e9269f0317a12ae2e3069f521fd36c161ccca1897878`
Latest full non-Windows release-gate package: `dist/eidp-windows-v388.zip`
Latest Windows-core-validated package: `dist/eidp-windows-v388.zip`
...
The current Mac-verifier-clean ZIP snapshot is v388. It packages commit
`8b64f51`, which keeps the read-only `scripts/stage6_recovery_check.py` helper
in the Windows ZIP, adds a Windows-local `scripts\stage6_recovery_check.bat`
wrapper for SSH-unavailable recovery, defaults that wrapper to the current
extracted package's `scripts\weekly_run.bat`, and records that path in the
packaged runbook. It preserves the v384 image-PDF ingest path that routes
through the packaged/system Tesseract TSV wrapper when available and records
OCR provenance in DB confidence breakdowns. The v388 versioned ZIP and latest
alias both pass
`scripts/verify_windows_distribution.py --json`; the latest alias also passes
with the v383 OCR add-on and v106 Playwright add-on. The v388 core SHA256 is
`399f484299716d481330e9269f0317a12ae2e3069f521fd36c161ccca1897878`, with
...
full non-Windows release gate is now v388 with `1406` unit tests, `44` exact
discovery gold-set predictions, and both package verifier modes passing
against SHA256
`399f484299716d481330e9269f0317a12ae2e3069f521fd36c161ccca1897878`.
...
Latest v388 package-verifier commands:

- `uv run python scripts/build_windows_zip.py --skip-download --out-zip dist/eidp-windows-v388.zip --latest-alias`
  -> wrote `dist/eidp-windows-v388.zip` and refreshed `dist/eidp-windows.zip`;
  both have SHA256
  `399f484299716d481330e9269f0317a12ae2e3069f521fd36c161ccca1897878`.
- `uv run python scripts/verify_windows_distribution.py --json dist/eidp-windows-v388.zip`
  -> `ok=true`, commit `8b64f51d919aa14523a4808bd7b038f82b65ea17`,
  ...
  included in the core ZIP contract.
...
- `uv run python scripts/verify_windows_distribution.py --json dist/eidp-windows.zip --ocr-addon dist/eidp-ocr-addon-windows-v383-smoke.zip --playwright-addon dist/eidp-playwright-addon-windows-v106.zip`
  -> `OK core`, `OK ocr-addon`, and `OK playwright-addon`, with matching v388
...
Latest v388 full non-Windows release-gate commands:

- `uv run python scripts/run_non_windows_release_gates.py dist/eidp-windows-v388.zip --json --output _temp/v388-non-windows-release-gates-full.json`
  -> `ok=true`; SHA256 sidecar matched
  `399f484299716d481330e9269f0317a12ae2e3069f521fd36c161ccca1897878`; full
  unit passed with `1406 passed, 5 warnings`; validator/distribution unit tests
  ...
  package verifier modes passed with the same v388 SHA256.
