...
Current Mac-verifier-clean package: `dist/eidp-windows-v364.zip`
Package commit: `53fc2a3093567b470956794c09ce123a4d85a77d`
Package SHA256: `9eb59b13e2360bad8b73fd5a3423a83bd6ca7b1ecc585a6a8f8d3207da073bed`
...
The current Mac-verifier-clean ZIP snapshot is v364 and passes the default
...
Latest v364 commands:

- `uv run pytest tests/unit -q` -> `1370 passed, 5 warnings`
...
- `uv run python scripts/build_windows_zip.py --skip-download --out-zip dist/eidp-windows-v364.zip`
  -> wrote `dist/eidp-windows-v364.zip` with SHA256
  `9eb59b13e2360bad8b73fd5a3423a83bd6ca7b1ecc585a6a8f8d3207da073bed`.
- `uv run python scripts/run_non_windows_release_gates.py dist/eidp-windows-v364.zip --json --output _temp/v364-non-windows-release-gates-full.json`
  -> `ok=true`, SHA256 sidecar matched, full unit passed, package verifier passed, and demonstrated-pattern gate passed.
- `uv run python scripts/run_non_windows_release_gates.py dist/eidp-windows-v364.zip --pdf-evidence _temp/win-v342-tokyo-probe/discovery_rejections_tokyo_v342_30.jsonl --pdf-evidence _temp/win-v342-evidence/discovery_rejections.jsonl --pdf-evidence _temp/seijuji-gold-v2/discovery_evidence.jsonl --pdf-evidence _temp/kousei-gold-v2/discovery_evidence.jsonl --pdf-evidence _temp/chuo-gold-v1/discovery_evidence.jsonl --pdf-evidence _temp/kimikan-manual-v2/discovery_evidence.jsonl --json --output _temp/v364-non-windows-release-gates-evidence.json`
