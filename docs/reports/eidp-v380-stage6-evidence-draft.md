...
| --- | --- | --- |
| Process gate / v1.0-rc | partial | v384 setup, diagnostics, UI service health, initial browser render, read-only quick navigation, FY2026 Excel disabled-state display, R7 Excel download, URL-candidate write, audit flush, fiscal-year override write, and manual-entry write; v380 SupportRecipient ingest smoke |
...
| Runtime DB mutation | 0 matching runtime rows for v384 manual-entry, v384 fiscal-year override, and SupportRecipient smoke markers |
