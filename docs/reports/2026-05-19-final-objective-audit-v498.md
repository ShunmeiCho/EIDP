...
- The focused Excel suite proves code-level master export, competition export,
  preview, and retroactive gate construction. The Windows v498 side-by-side
  smoke proves workbook creation on the operator OS, but owner business-value
  sign-off is still separate.
