...
canary, R7 browser Excel generation/download, default launcher, and
disk-retention lane. v453 is the retained Windows fallback package, v442
remains historical support for the fuller R7 parity workbook, and v408
...
- Current v454 package/Windows setup lane: package snapshot
  ...
  default `EIDP-start.bat` launcher health over local and tunneled HTTP, and
  v454-current plus v453-fallback retention. v442 remains historical support
  for the fuller R7 parity workbook.
