...
canary, R7 browser Excel generation/download, and disk-retention lane. v453 is
the retained Windows fallback package, v442 remains historical support for the
fuller R7 parity workbook, and v408
...
- Current v454 package/Windows setup lane: package snapshot
  ...
  generation/download through `output/playwright/v454-r7-excel-smoke/`, and
