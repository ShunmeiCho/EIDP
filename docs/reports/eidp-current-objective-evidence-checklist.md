...
`e1da33f` and includes the shared-corporation HTTP cache performance fix. v462
has now been Windows-transferred, SHA-checked, extracted side-by-side to
`C:\Users\cyo20\EIDP-v462-e1da33f`, setup-validated, and package-local
stub-cache-canary-proven. v460 remains the active Windows scheduled-task,
operator-cycle, companion handoff docs, disk-retention, read-only UI-health, and
browser-navigation lane at `C:\Users\cyo20\EIDP-v460-01e4427`. v459 remains the latest
...
write/audit sandbox regression. Mac and Win staging now retain v460 current plus
v459 fallback; stale v454 package/deploy artifacts were pruned after v460
validation. v442 remains historical support for the fuller R7 parity workbook,
...
execution pointer remains v460 at `C:\Users\cyo20\EIDP-v460-01e4427`: v462
side-by-side transfer/setup/cache canary passed, but v462 has not been
weekly-smoked, UI-health-smoked, evidence-bundled, or made the scheduled-task
target.
...
- Latest v462 Mac/non-Windows package and side-by-side Windows cache lane:
  package snapshot `e1da33fa50a651f9059e9562be5bf0e381b6fa32`, SHA256
  `1b783b640e6c25249dd8efd6d8355aeed986c7ecad80c72c98bd4e168360a59a`.
  `logs/release-gate-v462.json` returned `ok=true` with full unit
  `1666 passed`, validator package checks, mypy/Ruff, discovery-gold checks,
  package verification, and demonstrated-pattern verification. Windows
  side-by-side transfer, SHA check, extraction to
...
- Historical v456 browser/evidence lane: package snapshot
  ...
  artifacts were pruned and v460 current plus v459 fallback are the only
  retained Windows deploy directories.
