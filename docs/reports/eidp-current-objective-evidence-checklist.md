...
- Current Mac/non-Windows release-gate proof: v417, package snapshot
  ...
  differing fields against `_temp/v408-r7-cli-export.xlsx`. v417 is not
  Windows-proven.
