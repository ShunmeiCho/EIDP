...
UI-health and browser-navigation proof on Windows port `8508`. v463 remains the
...
`write_actions_invoked=false`, and `weekly_invoked=false`. v463 remains the latest
