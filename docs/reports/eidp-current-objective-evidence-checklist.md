...
- `uv run python scripts/run_non_windows_release_gates.py dist/eidp-windows-v415.zip --skip-full-unit --allow-docs-only-stale-package --json --output logs/release-gate-v415-docs-only-stale.json`
