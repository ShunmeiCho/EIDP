...
the code evidence base `21282027`, and the active operator-PC Stage 6 lane
...
- Current source-code evidence base: `21282027`, with Stage 6 safety fixes for recovery check,
...
- These source-code fixes are not present in the existing v399/v401 ZIPs.
  ...
  base `212820276d61ad7a40d265b7a58d400ad4c9b4dd`, because v401 packages
...
Latest local checks performed against source-code evidence base `21282027`:
...
- `uv run python scripts/run_non_windows_release_gates.py dist/eidp-windows-v401.zip --skip-full-unit --json --output _temp/v401-non-windows-release-gates-stale-commit-ae835a1c.json`
  ...
  latest code-affecting source base `21282027` has been packaged.
