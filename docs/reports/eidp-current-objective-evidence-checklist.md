...
retroactive/forecast weekly runs. v462 remains the latest Windows side-by-side
cache package and has been Windows-transferred, SHA-checked, extracted to
...
target; v463 has not been Windows-transferred yet.
...
- Latest v463 Mac/non-Windows package lane:
  ...
  weekly runs. It has not been Windows-transferred yet.
