...
UI-health, default launcher, browser read-only navigation, bounded canary, and
disk-retention lane. v454 remains the latest Windows R7 browser Excel
generation/download, UI write/audit sandbox proof, and retained fallback package.
...
- Current v454 package/Windows setup lane: package snapshot
  ...
  evidence-bundle verification with `weekly_run_logs`, UI health, process-scoped
  R7 Excel browser generation/download through `output/playwright/v454-r7-excel-smoke/`,
