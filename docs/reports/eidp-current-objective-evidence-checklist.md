...
- Latest source/package discovery fix: v521 school-override corporation suppression
...
| Current FY2026 strict target-PDF/Excel-ready yield is `>= 60%` | v502 limit-50 canary: strict/Excel-ready `10.0%`; v515 Mac continuation canary from the v513 isolated DB: strict `2/50 (4.0%)`; v516 target-missing canary after confirmed-target exclusion: strict `0/50 (0.0%)`; v519 Mac continuation canary with checked-in URL sources: strict `0/50 (0.0%)`; v521 Mac continuation canary after corporation suppression: strict `0/50 (0.0%)`; production-scale upper-bound proof: max possible `39.3%` after 607/1000 schools | FAIL |
