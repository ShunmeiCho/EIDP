...
Windows canary evidence. The staged owner handoff docs still target v544, so a
new owner-doc handoff would be needed before treating the v545 worksheet as the
staged owner worksheet.
