...
- Current Mac/non-Windows release-gate proof: v420, package snapshot
  ...
  differing fields against `_temp/v408-r7-cli-export.xlsx`. v419 Mac-only
  FY2024/FY2023 reference-gate replays in
  `logs/release-gate-v419-retroactive-fy2024-reference.json` and
  `logs/release-gate-v419-retroactive-fy2023-reference.json` also returned
  `ok=true`, with fresh isolated exports under
  `_temp/non-windows-retroactive-fy2024-20260515-135655` and
  `_temp/non-windows-retroactive-fy2023-20260515-135744`; both produced the same
  four workbook row counts and zero business-value diffs against their stable
  generated references. v420 is not Windows-proven.
