...
generation/download, bounded canary, and disk-retention lane. v454 remains the
latest Windows UI write/audit sandbox proof and retained fallback package.
