...
| v417 retroactive FY2024/R6 Excel regression | pass | `logs/release-gate-v417-retroactive-fy2024-reference.json` returned `ok=true`; isolated app root `_temp/non-windows-retroactive-fy2024-20260515-132748` exported FY2024 and `retroactive_excel_diff_reference` returned zero missing/extra rows and zero differing fields against the stable FY2024 generated reference. |
| v417 retroactive FY2023/R5 Excel regression | pass | `logs/release-gate-v417-retroactive-fy2023-reference.json` returned `ok=true`; isolated app root `_temp/non-windows-retroactive-fy2023-20260515-132835` exported FY2023 and `retroactive_excel_diff_reference` returned zero missing/extra rows and zero differing fields against the stable FY2023 generated reference. |
...
| Excel template export | v417 isolated FY2025/R7 export matched `_temp/v408-r7-cli-export.xlsx` with `missing_rows=0`, `extra_rows=0`, `differing_fields=0`; FY2024/R6 and FY2023/R5 follow-up gates matched their stable generated references with the same zero business-value diff counts. | Mac retroactive proof only |
